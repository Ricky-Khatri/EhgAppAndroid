...
public class LatestOffersFragment extends BaseFragment implements OnClickListener {
  ...
  private void initView(View view) {
    ...
    try {
      ...
      view.findViewById(R.id.linearlayout_latestoffers_sort).setOnClickListener(this);
      view.findViewById(R.id.linearlayout_latestoffers_filter).setOnClickListener(this);

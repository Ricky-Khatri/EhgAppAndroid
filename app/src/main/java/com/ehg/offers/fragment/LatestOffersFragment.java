/*
 *  Created by Emaar Hospitality Group on 24/9/18 11:21 AM
 *  Copyright (C) 2018  All rights reserved.
 *  Last modified 24/9/18 11:21 AM
 *
...
/**
 * This class will show lis of all latest offers.
 */
public class LatestOffersFragment extends BaseFragment implements OnClickListener {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    View view = inflater.inflate(R.layout.fragment_latestoffers, container, false);
  ...
  private void initView(View view) {
    ...
    try {
      ...
      initLatestOfferList(view);

      LinearLayout linearLayoutSort = view.findViewById(R.id.linearlayout_latestoffers_sort);
      linearLayoutSort.getLayoutParams().width
          = (AppUtil.getDeviceWidth((AppCompatActivity) context) / 2) - 30;
      LinearLayout linearLayoutFilter = view.findViewById(R.id.linearlayout_latestoffers_filter);
  ...
  /**
   * Called to init latest offer list.
   *
   * @param view view
   */

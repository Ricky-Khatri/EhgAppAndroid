/*
 *  Created by Emaar Hospitality Group on 23/10/18 12:32 PM
 *  Copyright (C) 2018  All rights reserved.
 *  Last modified 23/10/18 12:32 PM
 *
...
/**
 * This class init's scene items in list.
 */
public class SceneAdapter extends RecyclerView.Adapter<SceneAdapter.ViewHolder> {
   ...
   */
  public SceneAdapter(Context context, int itemHeight, ArrayList<LightPojo> lightList,
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
    ...
    public void onClick(View view) {
      if (onSceneItemClickListener != null) {
        ...
        onSceneItemClickListener.onSceneItemClicked(getAdapterPosition());
      }
    }
  }

  /**
   * SceneItem click listener.
   */
  public interface OnSceneItemClickListener {

    void onSceneItemClicked(int position);
  }
}

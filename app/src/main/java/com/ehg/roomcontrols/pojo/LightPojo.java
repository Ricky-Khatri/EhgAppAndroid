/*
 *  Created by Emaar Hospitality Group on 23/10/18 12:10 PM
 *  Copyright (C) 2018  All rights reserved.
 *  Last modified 23/10/18 12:10 PM
 *
...
/**
 * Light Pojo for light automation.
 */
public class LightPojo {
   ...
   * Getter method.
   *
   * @return Gets the value of isLightOn and returns isLightOn.
   */
  ...
  /**
   * Sets the isLightOn. You can use getLightOn() to get the value of isLightOn.
   */

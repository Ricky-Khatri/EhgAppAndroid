 ...
 */
public class HotelResortAdapter extends RecyclerView.Adapter<HotelResortAdapter.ViewHolder> {

  private final LayoutInflater inflater;

  /**
   * Parameterized constructor for HotelResortAdapter.
   */
  public HotelResortAdapter(Context context) {
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
    return new HotelResortAdapter.ViewHolder(inflater.inflate(R.layout.item_hotelresort,
        viewGroup, false));
  }

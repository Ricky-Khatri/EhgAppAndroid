 ...
 * AllRoomType class.
 */
public class AllRoomType {

  @SerializedName("Amenities")
  private List<Amenity> amenities;
  @SerializedName("Available")
  private Boolean available;
  @SerializedName("AvailableInventoryThreshold")
  private int availableInventoryThreshold;
   ...
   * Getter method.
   *
   * @return Gets the value of availableInventoryThreshold and returns availableInventoryThreshold.
   */
  public int getAvailableInventoryThreshold() {
    return availableInventoryThreshold;
  }

  /**
   * Sets the availableInventoryThreshold. You can use getAvailableInventoryThreshold() to get the
   * value of availableInventoryThreshold.
   */
  public void setAvailableInventoryThreshold(int availableInventoryThreshold) {
    this.availableInventoryThreshold = availableInventoryThreshold;
  }

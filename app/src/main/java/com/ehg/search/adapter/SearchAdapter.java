/*
 *  Created by Emaar Hospitality Group on 3/10/18 2:34 PM
 *  Copyright (C) 2018  All rights reserved.
 *  Last modified 3/10/18 2:31 PM
 *
...
public class SearchAdapter extends BaseExpandableListAdapter {
  ...
  /**
   * Parameterized constructor for SearchAdapter.
   */
  public SearchAdapter(Context context, List<SearchGroupPojo> listGroup) {

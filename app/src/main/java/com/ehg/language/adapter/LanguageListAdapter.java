...
public class LanguageListAdapter extends
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
    View view = LayoutInflater.from(viewGroup.getContext())
        .inflate(R.layout.item_language_list, viewGroup, false);
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
    ...
    public ViewHolder(View view) {
      super(view);
      itemView = view;
      textViewLanguageName = view.findViewById(R.id.textview_language_languagename);
      checkbox = view.findViewById(R.id.checkbox_language_languagechekbox);
